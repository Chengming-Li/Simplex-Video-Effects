...
from NewFBAMatting import NewFBAMatting
from carvekit.ml.wrap.tracer_b7 import TracerUniversalB7
from NewU2Net import U2NET
from NewPostProcessing import NewMattingMethod
from carvekit.trimap.generator import TrimapGenerator


class HiInterface(NewInterface):
    def __init__(
        self,
        ...
        Notes:
            ...
            refining quality,
        """
        self.func1 = LoaderFunc1
        self.func2 = LoaderFunc2
        ...
        super(HiInterface, self).__init__(
            pre_pipe=None,
            seg_pipe=self.u2net,
            post_pipe=NewMattingMethod(matting_module=self.fba, trimap_generator=self.trimap_generator, device=device,),
            device=device,
        )
